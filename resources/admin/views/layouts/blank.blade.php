...
<head>
    ...
    <title>Blank | {{ config('app.name') }}</title>
...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
            <img class="navbar-brand-logo" src="/assets/admin/assets/images/logo.png" title="Remark">
                                    ...
                                    <ul class="blocks-3">
                                        <li>
                                            <a class="thumbnail m-0" href="javascript:void(0)">
                                                <img class="w-full" src="/assets/admin/photos/placeholder.png"
                                                     alt="..."/>
                                            </a>
                                        </li>
                                        <li>
                  ...
                  <i></i>
                    ...
                    <div class="dropdown-menu" role="menu">
                        ...
                        <a class="dropdown-item" href="{{ route('logout') }}"
                           ...
                           role="menuitem"><i class="icon md-power" aria-hidden="true"></i> Sign out</a>
